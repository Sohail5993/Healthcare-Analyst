      ...
      <article class="project">
        ...
        <div class="project-body">
          ...
          <div class="project-links">
            ...
            <a href="https://github.com/sohail5993/Strategic-HealthCare-Analyst">View repository</a>
          </div>
        </div>
      </article>
    ...
    <section class="projects wrap">
      ...
      <article class="project">
        ...
        <div class="project-body">
          ...
          <div class="project-links">
            <a href="https://github.com/sohail5993/Provider-Network-Adequacy-Analysis">View repository</a>
...
write_page(
    ...
    <section class="case-study wrap">
      ...
      <div class="cs-links">
        <a href="https://github.com/sohail5993/Strategic-HealthCare-Analyst">View repository</a>
        <a href="https://sohail5993.github.io/Strategic-HealthCare-Analyst/">View live results</a>
      </div>
    </section>
    ...
    <section class="case-study wrap" id="provider-network-adequacy">
      ...
      <div class="cs-links">
        <a href="https://github.com/sohail5993/Provider-Network-Adequacy-Analysis">View repository</a>
        <a href="https://github.com/sohail5993/Provider-Network-Adequacy-Analysis/blob/main/outputs/Provider_Network_Adequacy_One_Pager.pdf">View one-pager</a>
      </div>
    </section>
